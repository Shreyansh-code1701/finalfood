...
<?php
$get = mysql_query("select s.storename,s.address,a.* from store s,addbanner a where a.storeid = s.storeid and a.adid=(select max(adid) from addbanner where userid like '$_SESSION[user]')");
...
if ($row[10] == 0) {
    ?>
                                    ...
                                    <tr>
                                        <td colspan="4">Store Name : <?php echo $row[0]; ?></td>
                                    </tr>

                                    <tr>
                                        <td colspan="4">Address : <?php echo $row[1]; ?></td>
                                    </tr>

<?php
$g = mysql_query("select * from timeperiod where timeperiodid=$row[3]");
