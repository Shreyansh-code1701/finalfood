                        ...
                        <section class="panel state">
                           <header class="panel-heading" style="background: #e0e1e7 !important;">
                                ...
                                <div class="col-md-offset-5 col-md-4 col-sm-10 col-xs-10">
                                    ...
                                    <select style="padding: 8px;" class="form-control" onclick="reestore('storeevent','store','up',this.value,'0');  bbackup('event','store','dis',this.value,'0','backup');">
                            ...
                            <div class="panel-body">
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        <div class="col-md-6 col-sm-12 col-xs-12">
                                            <fieldset>
                                                            <legend style="padding-bottom: 10px">CHOOSE EVENT</legend>
                                                    </fieldset> 
                                            <div id="addstoreevent">
                                        ...
                                        <div class="col-md-6 col-sm-12 col-xs-12" id="selectcuisine" >
                                                    <fieldset>
                                                            <legend style="padding-bottom: 10px">SELECTED EVENT</legend>
                                                    </fieldset> 
                                                <div id="addevent">
