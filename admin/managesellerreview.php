                                ...
                                <ul class="nav nav-tabs pull-right">
                                    <li class="active">
                                        <a href="#home-3" data-toggle="tab">
                                            <i class="fa fa-laptop" ondblclick="fdel('sreview','delete','<?php echo $p; ?>','<?php echo $pp; ?>','<?php echo $row[0]; ?>');recycle('sreview','display','1','10');"></i>
                                            DISPLAY
                                        </a>
                                    </li>
                                        ...
                                        <form action="" method="post" name="searchreview">
                                            <div class="form-group">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" name="search" placeholder="Search here.." id="find" class="form-control" onkeyup="display('sreview','display','1','10');"/>
                                                    <div class="input-group-addon">
