...
<html lang="en">
    ...
    <body class="sticky-header" onload="missbill('missbannerbill','today',0);">
                        ...
                        <section class="panel state">
                            <header class="panel-heading" style="background: #e0e1e7 !important;">
                                ...
                                <div class="col-md-offset-5 col-md-4 col-sm-10 col-xs-10">
                                    ...
                                    <select style="padding: 8px;" class="form-control" onchange="missbill('missbannerbill',this.value,0);">
